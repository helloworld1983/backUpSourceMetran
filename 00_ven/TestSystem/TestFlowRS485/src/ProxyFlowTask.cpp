...
{
    xTaskCreate(Entry, "ProxyFlowTask", 5*configMINIMAL_STACK_SIZE,NULL,
                (tskIDLE_PRIORITY + 5UL), (TaskHandle_t *) NULL);
}
...
void GetDeviceName(void)
{
    ...
    ProxyFlowSensor::S_GetInstance()->ConvertReceiveDataToFrameData(cmd, num, &recData);
