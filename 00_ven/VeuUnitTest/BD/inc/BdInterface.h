...
// BD Queue.
typedef enum {
    // place holder; not a valid event.
    eNoBdEventId,
    ...
    eVentTypeChangeId = eFirstSingleSettingChangeId,
    ...
    ePfChangeId,
    eFlowPatternChangeId,
    eSupportPressChangeId,
    eTvChangeId,
    eNippvIpapChangeId,
    eRiseTimeChangeId,
    eVolumeBatchChangeId,
    eExhSensChangeId,
