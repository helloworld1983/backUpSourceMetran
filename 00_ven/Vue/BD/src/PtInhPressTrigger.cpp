/******************************************************************************/
//$COMMON.CPP$
//   File Name:  PtInhPressTrigger.cpp
...
/******************************************************************************/
//$COMMON.OPERATION$
//    Operation Name: PtInhPressTrigger()
//
//    Processing: 
...
E_Bool PtInhPressTrigger::CheckCondition (void)
{
    if (MgrBdSetting::S_GetInstance()->GetPressTriggOn())
    {
        ...
        if (eTrue == InUnrestrictedPhase)
        {
            ...
            PressureLimit = (SHORT) (mgrBdSettingPtr->GetCurrentValue(eBaselinePress)
                    - PressSens);
...
//
//    Processing: 
//      This operation is invoked to enable the PtInhPressTrigger using the
...
//      IsPressureFixed to FALSE.  It then invokes the GetCurrentValue()
...
//
//    Processing: 
//      This operation is invoked to enable the PtInhPressTrigger using a
...
//
//      This operation then invokes MgrBdSetting::GetCurrentValue()  to
...
void PtInhPressTrigger::PhaseInSettingChange (LONG value)
{
    ...
    if ((eTrue == IsEnabled) && (eFalse == IsPressureFixed))
    {
        ...
        PressureLimit = (SHORT)(mgrBdSettingPtr->GetCurrentValue(eBaselinePress) - value);
    }
