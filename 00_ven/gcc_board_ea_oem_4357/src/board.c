 ...
 * Private functions
 ****************************************************************************/
extern void Chip_LCD_Init(LPC_LCD_T *pLCD, LCD_CONFIG_T *LCD_ConfigStruct)
{

}
extern uint32_t Chip_I2CM_XferBlocking(LPC_I2C_T *pI2C, I2CM_XFER_T *xfer)
{
    return 0;
}
extern void Chip_I2S_Init(LPC_I2S_T *pI2S)
{

}

extern Status Chip_I2S_TxConfig(LPC_I2S_T *pI2S, I2S_AUDIO_FORMAT_T *format)
{
    return 0;
}
...
void Board_UART_Init(LPC_USART_T *pUART)
{
	if (pUART == LPC_USART0) {
		...
		Chip_SCU_PinMuxSet(0x9, 3, (SCU_MODE_PULLDOWN | SCU_MODE_FUNC7));			/* P2.3 : UART3_TXD */
