#ifndef INC_PDALARM_H_
#define INC_PDALARM_H_
...
public:
    ...
    void CheckHiCondition (LONG hilimit, LONG value, int alarmID, int SensitiveValue = 0, int SimulatesenValCounter = 0);

    // check for low alarm condition
    void CheckLowCondition (LONG lowlimit, LONG value, int alarmID, int SensitiveValue = 0, int SimulatesenValCounter = 0);
