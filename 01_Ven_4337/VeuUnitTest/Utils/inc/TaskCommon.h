...
#define TASK_PRIO_BD_TASK           (tskIDLE_PRIORITY + 5UL)
...
#define ALARM_TASK_SIZE             (configMINIMAL_STACK_SIZE * 10)
#define BD_TASK_SIZE                (configMINIMAL_STACK_SIZE * 2)
#define PD_TASK_SIZE                (configMINIMAL_STACK_SIZE * 2)
#define IPC_TASK_SIZE               (configMINIMAL_STACK_SIZE * 5)
