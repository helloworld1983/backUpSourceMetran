...
public:
    ...
    virtual void CalcCompensatedPeakFlow (LONG complCompVol) = 0;
...
/******************************************************************************/
//$COMMON.OPERATION$
//    Operation Name: SetCompensatedPeakFlow()
//
//    Processing: 
//      This operation sets the CompensatedPeakFlow to the passed argument.
//
//    Input Parameters:
//      setPeakFlow - operator setting for Peak Flow in ml/sec * SCALE
//
//    Output Parameters:
//      None
//
...
//
/******************************************************************************/
inline void FlowPattern::SetCompensatedPeakFlow (LONG setPeakFlow)
{
...
/******************************************************************************/
//$COMMON.OPERATION$
//    Operation Name: GetCompensatedPeakFlow()
//
//    Processing:
//      This operation returns the CompensatedPeakFlow.
//
//    Input Parameters:
//      None
//
...
//
//    Return Values:
//      the CompensatedPeakFlow for the flow pattern.
//
//    Pre-Conditions:
//      None
//
...
//
/******************************************************************************/
inline LONG FlowPattern::GetCompensatedPeakFlow()
{
