...
PhaseMgr::PhaseMgr (void)
{
    ...
    PhaseList[ePcvInhPhase] = new MandPressInhPhase(ePcvInhPress,
                                                    eBaselinePress);


    PhaseList[ePsvInhPhase] = new SupportedInhPhase(eSupportPress,
                                                    eBaselinePress);

    PhaseList[ePsvInhPhase_InAPRV_PLow] = new APRV_SupportedInhPhase_InPLow(eSupportPress,
                                                                            eAPRVLowInhPress);

    PhaseList[ePsvInhPhase_InAPRV_PHigh] = new APRV_SupportedInhPhase_InPHigh(eSupportPress,
                                                                              eAPRVHighInhPress);

    PhaseList[eTheMandInhTestBreathPhase] = new InhTestBreathPhase(ePcvInhPress,
                                                                   eBaselinePress);
