...
static const char pDevNameString[] = "Spansion S25FL016K FLASH";
 ...
 * Public functions
 ****************************************************************************/
SPIFI_DEV_FAMILY_T *SPIFI_REG_FAMILY_SpansionS25FL016K(void)
{
...

	{
		...
		static const SPIFI_DEV_PDATA_T pData = {
				{0xef, 0x40, 0x15, 0},	/* ID bytes returned from read id (4th byte not used) */
				32,             		/* # of blocks */
				0x10000,    			/* block size */
				512,                 	/* # of sub-blocks */
...
SPIFI_DEV_FAMILY_T *SPIFI_REG_FAMILY_SpansionS25FL256SAGNFI000(void)
{
	static SPIFI_DEV_FAMILY_T handle;
	static SPIFI_DEVDESC_T desc;
	...
	{
	static const SPIFI_DEV_PDATA_T pData = {
			{0x01, 0x02, 0x19, 2},	/* JEDEC ID, extCount, ext data  */
			512,					/* # of blocks */
			0x10000,				/* block size */
			0,						/* # of sub-blocks (Does NOT support full sub-block erase) */
			0,						/* sub-block size 0x1000 */
			256,					/* page size */
			16128,					/* max single read bytes */
			80000000,				/* max clock rate in MHz */
