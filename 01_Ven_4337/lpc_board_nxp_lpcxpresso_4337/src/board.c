...
{
	if (pUART == LPC_USART0) {
		Chip_SCU_PinMuxSet(0x2, 0, (SCU_MODE_PULLDOWN | SCU_MODE_FUNC1));		/*UART0_TXD*/
		Chip_SCU_PinMuxSet(0x2, 1, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC1));	/*UART0_RXD*/
	}
	else if (pUART == LPC_USART3) {
		Chip_SCU_PinMuxSet(0x4, 1, (SCU_MODE_PULLDOWN | SCU_MODE_FUNC6));			/*UART3_TXD*/
		Chip_SCU_PinMuxSet(0x4, 2, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC6));	/*UART3_RXD*/
	}
//	else if (pUART == LPC_USART2) {
//		Chip_SCU_PinMuxSet(0x1, 15, (SCU_MODE_PULLDOWN | SCU_MODE_FUNC1));			/*UART2_TXD*/
//		Chip_SCU_PinMuxSet(0x1, 16, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC1));	/*UART3_RXD*/
//	}
//	else if (pUART == LPC_UART1)
//	{
//		Chip_SCU_PinMuxSet(0x1, 13, (SCU_MODE_PULLDOWN | SCU_MODE_FUNC1));			/*UART1_TXD*/
//		Chip_SCU_PinMuxSet(0x1, 14, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC1));	/*UART1_RXD*/
//	}
}
...
void Board_UARTDebug(const char *fmt, ...)
{
#if defined(DEBUG_UART)
    char buffer[4096];
    va_list args;
...
void Board_Init(void)
{
	...
	/* Initialize LEDs */
//	2017/10/05 Quyen Ngo Remove unnecessary code
//	Board_LED_Init();
