...
void MgrBdSetting::ReceiveRequest (const BdEvent& bdEvent)
{
    ...
    DEBUG_MGR_BDSETTING("ReceiveRequest = %x \n", id);
    ...
    if ((id >= eFirstSingleSettingChangeId) && (id <= eLastSingleSettingChangeId))
    {
        ...
        SettingList[id - eFirstSingleSettingChangeId]->SetPendingValue(bdEvent.SingleSettingChangeEvent.Value);
        DEBUG_MGR_BDSETTING("settingList [%d] set value = %d", id - eFirstSingleSettingChangeId, bdEvent.SingleSettingChangeEvent.Value);
