...
#ifdef MGR_ALARM_STAT_EN
#define DEBUG_MGR_ALARM_STAT(...) Board_UARTDebug(__VA_ARGS__)
#else
#define DEBUG_MGR_ALARM_STAT(...)
#endif  //#define MGR_ALARM_STAT_EN

#ifdef CBIT_EN
#define DEBUG_CBIT(...) Board_UARTDebug(__VA_ARGS__)
#else
#define DEBUG_CBIT(...)
...
#ifdef MGR_MODE_EN
#define DEBUG_MGR_MODE(...) Board_UARTDebug(__VA_ARGS__)
#else
