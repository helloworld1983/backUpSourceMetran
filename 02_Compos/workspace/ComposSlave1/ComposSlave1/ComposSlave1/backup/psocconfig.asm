...
export LoadConfig_composslave1
export _LoadConfig_composslave1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_composslave1
	lcall	LoadConfigTBL_composslave1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration composslave1
;
;    Load configuration registers for composslave1.
...
;               CUR_PP
;
_LoadConfig_composslave1:
 LoadConfig_composslave1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_composslave1_Bank0
    mov     X, <LoadConfigTBL_composslave1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_composslave1_Bank1
    mov     X, <LoadConfigTBL_composslave1_Bank1
