...
export LoadConfigTBL_composslave1_Bank1
export LoadConfigTBL_composslave1_Bank0
export LoadConfigTBL_composslave1_Ordered
AREA lit(rom, rel)
LoadConfigTBL_composslave1_Bank0:
;  Instance name Counter8_1, User Module Counter8
;       Instance name Counter8_1, Block Name CNTR8(DBB11)
	db		37h, 00h		;Counter8_1_CONTROL_REG(DBB11CR0)
	db		35h, ffh		;Counter8_1_PERIOD_REG(DBB11DR1)
	db		36h, 00h		;Counter8_1_COMPARE_REG(DBB11DR2)
;  Instance name Counter8_2, User Module Counter8
;       Instance name Counter8_2, Block Name CNTR8(DCB12)
	db		3bh, 00h		;Counter8_2_CONTROL_REG(DCB12CR0)
	db		39h, ffh		;Counter8_2_PERIOD_REG(DCB12DR1)
	db		3ah, 00h		;Counter8_2_COMPARE_REG(DCB12DR2)
;  Instance name DAC9_1, User Module DAC9
;       Instance name DAC9_1, Block Name LSB(ASD22)
	db		98h, 80h		;DAC9_1_LSB_CR0(ASD22CR0)
	db		99h, 80h		;DAC9_1_LSB_CR1(ASD22CR1)
	db		9ah, 20h		;DAC9_1_LSB_CR2(ASD22CR2)
	db		9bh, 30h		;DAC9_1_LSB_CR3(ASD22CR3)
;       Instance name DAC9_1, Block Name MSB(ASC23)
	db		9ch, a0h		;DAC9_1_MSB_CR0(ASC23CR0)
	db		9dh, 41h		;DAC9_1_MSB_CR1(ASC23CR1)
	db		9eh, a0h		;DAC9_1_MSB_CR2(ASC23CR2)
	db		9fh, 34h		;DAC9_1_MSB_CR3(ASC23CR3)
...
;       Instance name PWM8_1, Block Name PWM8(DBB10)
	...
	db		31h, 7ch		;PWM8_1_PERIOD_REG(DBB10DR1)
	db		32h, 7ch		;PWM8_1_COMPARE_REG(DBB10DR2)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DCB13)
	db		3fh, 00h		;PWM8_2_CONTROL_REG(DCB13CR0)
	db		3dh, 63h		;PWM8_2_PERIOD_REG(DCB13DR1)
	db		3eh, 63h		;PWM8_2_COMPARE_REG(DCB13DR2)
;  Global Register values Bank 0
	db		60h, 20h		; AnalogColumnInputSelect register (AMX_IN)
	db		66h, 00h		; AnalogComparatorControl1 register (CMP_CR1)
	db		63h, 16h		; AnalogReferenceControl register (ARF_CR)
	...
	db		ffh
LoadConfigTBL_composslave1_Bank1:
;  Instance name Counter8_1, User Module Counter8
;       Instance name Counter8_1, Block Name CNTR8(DBB11)
	db		34h, 21h		;Counter8_1_FUNC_REG(DBB11FN)
	db		35h, 1ch		;Counter8_1_INPUT_REG(DBB11IN)
	db		36h, 40h		;Counter8_1_OUTPUT_REG(DBB11OU)
;  Instance name Counter8_2, User Module Counter8
;       Instance name Counter8_2, Block Name CNTR8(DCB12)
	db		38h, 21h		;Counter8_2_FUNC_REG(DCB12FN)
	db		39h, 1eh		;Counter8_2_INPUT_REG(DCB12IN)
	db		3ah, 40h		;Counter8_2_OUTPUT_REG(DCB12OU)
;  Instance name DAC9_1, User Module DAC9
;       Instance name DAC9_1, Block Name LSB(ASD22)
;       Instance name DAC9_1, Block Name MSB(ASC23)
;  Instance name DUALADC_1, User Module DUALADC
...
;       Instance name DUALADC_1, Block Name CNT2(DCB03)
	...
	db		2dh, 55h		;DUALADC_1_fCounter2SL(DCB03IN)
...
;       Instance name PWM8_1, Block Name PWM8(DBB10)
	...
	db		31h, 11h		;PWM8_1_INPUT_REG(DBB10IN)
	db		32h, 40h		;PWM8_1_OUTPUT_REG(DBB10OU)
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DCB13)
	db		3ch, 21h		;PWM8_2_FUNC_REG(DCB13FN)
	db		3dh, 15h		;PWM8_2_INPUT_REG(DCB13IN)
	db		3eh, 45h		;PWM8_2_OUTPUT_REG(DCB13OU)
;  Global Register values Bank 1
	...
	db		60h, 50h		; AnalogColumnClockSelect register (CLK_CR0)
