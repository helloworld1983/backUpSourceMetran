...
export LoadConfig_composslave2b
export _LoadConfig_composslave2b
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_composslave2b
	lcall	LoadConfigTBL_composslave2b_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration composslave2b
;
;    Load configuration registers for composslave2b.
...
;               CUR_PP
;
_LoadConfig_composslave2b:
 LoadConfig_composslave2b:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_composslave2b_Bank0
    mov     X, <LoadConfigTBL_composslave2b_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_composslave2b_Bank1
    mov     X, <LoadConfigTBL_composslave2b_Bank1
