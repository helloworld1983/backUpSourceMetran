...
export LoadConfigTBL_composslave2b_Bank1
export LoadConfigTBL_composslave2b_Bank0
export LoadConfigTBL_composslave2b_Ordered
AREA lit(rom, rel)
LoadConfigTBL_composslave2b_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_composslave2b_Bank1:
;  Instance name EzI2Cs_1, User Module EzI2Cs
;  Instance name LED_1, User Module LED
;  Instance name LED_10, User Module LED
;  Instance name LED_8, User Module LED
...
LoadConfigTBL_composslave2b_Ordered:
