...
export LoadConfigTBL_composslave3a_Bank1
export LoadConfigTBL_composslave3a_Bank0
export LoadConfigTBL_composslave3a_Ordered
AREA lit(rom, rel)
LoadConfigTBL_composslave3a_Bank0:
...
;  Instance name LED_9, User Module LED
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_composslave3a_Bank1:
;  Instance name EzI2Cs_1, User Module EzI2Cs
;  Instance name LED_1, User Module LED
;  Instance name LED_10, User Module LED
;  Instance name LED_8, User Module LED
...
LoadConfigTBL_composslave3a_Ordered:
