...
export LoadConfig_composslave3a
export _LoadConfig_composslave3a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_composslave3a
	lcall	LoadConfigTBL_composslave3a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration composslave3a
;
;    Load configuration registers for composslave3a.
...
;               CUR_PP
;
_LoadConfig_composslave3a:
 LoadConfig_composslave3a:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_composslave3a_Bank0
    mov     X, <LoadConfigTBL_composslave3a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_composslave3a_Bank1
    mov     X, <LoadConfigTBL_composslave3a_Bank1
