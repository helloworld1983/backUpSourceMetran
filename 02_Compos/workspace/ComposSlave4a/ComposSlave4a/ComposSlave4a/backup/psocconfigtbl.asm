...
export LoadConfigTBL_composslave4a_Bank1
export LoadConfigTBL_composslave4a_Bank0
export LoadConfigTBL_composslave4a_Ordered
AREA lit(rom, rel)
LoadConfigTBL_composslave4a_Bank0:
;  Instance name EzI2Cs_1, User Module EzI2Cs
;  Instance name LED_1, User Module LED
;  Instance name LED_10, User Module LED
;  Instance name LED_11, User Module LED
;  Instance name LED_12, User Module LED
;  Instance name LED_13, User Module LED
;  Instance name LED_14, User Module LED
;  Instance name LED_15, User Module LED
;  Instance name PWM8_1, User Module PWM8
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	db		23h, 00h		;PWM8_1_CONTROL_REG(DBB00CR0)
	db		21h, 31h		;PWM8_1_PERIOD_REG(DBB00DR1)
	db		22h, 31h		;PWM8_1_COMPARE_REG(DBB00DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_composslave4a_Bank1:
;  Instance name EzI2Cs_1, User Module EzI2Cs
;  Instance name LED_1, User Module LED
;  Instance name LED_10, User Module LED
;  Instance name LED_11, User Module LED
...
;       Instance name PWM8_1, Block Name PWM8(DBB00)
	...
	db		22h, 40h		;PWM8_1_OUTPUT_REG(DBB00OU)
;  Global Register values Bank 1
	...
	db		dfh, 18h		; OscillatorControl_3 register (OSC_CR3)
...
LoadConfigTBL_composslave4a_Ordered:
;  Ordered Global Register values
	...
	mov	reg[04h], fch		; Port_1_Data register (PRT1DR)
	M8C_SetBank1
