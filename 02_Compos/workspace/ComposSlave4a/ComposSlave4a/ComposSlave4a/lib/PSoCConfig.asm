...
export LoadConfig_composslave4a
export _LoadConfig_composslave4a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_composslave4a
	lcall	LoadConfigTBL_composslave4a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration composslave4a
;
;    Load configuration registers for composslave4a.
...
;               CUR_PP
;
_LoadConfig_composslave4a:
 LoadConfig_composslave4a:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_composslave4a_Bank0
    mov     X, <LoadConfigTBL_composslave4a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_composslave4a_Bank1
    mov     X, <LoadConfigTBL_composslave4a_Bank1
