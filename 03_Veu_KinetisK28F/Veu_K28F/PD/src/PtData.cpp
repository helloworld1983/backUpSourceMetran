...
void Ptdata::BuildInhMsg (void)
{
    ...
    DEBUG_PTDATA("Build INH MSG and send \n");

    InhMsg.PeakInspiratoryPressure = 1;
    InhMsg.EndInhalationPressure = 2;
    InhMsg.TimeInInhalation = 3;
    InhMsg.InhalationType = eSpontaneous;


    InhMsg.InhaledTidalVolume = 5;
    InhMsg.InhaledMinuteVolume = 6;
...
void Ptdata::BuildExhMsg (void)
{
    ...
    DEBUG_PTDATA("Build EXH MSG and send \n");
    ExhMsg.MeanAirwayPressure = 0;
    ExhMsg.SpontaneousMinuteVolume = 1;
    ExhMsg.TotalRespiratoryRate = 2;
    ExhMsg.SpontaneousRespiratoryRate = 3;
    ExhMsg.IERatio = 4;
    ExhMsg.RapidShallowBreathingIndex = 5;
    ExhMsg.TimeInExhalation = 6;
    ExhMsg.ProxymalLeak = 7;
    ExhMsg.Compliance = (LONG)8;

    ExhMsg.ExhaledMinuteVolume = 9;
    ExhMsg.TidalVolume = 10;
