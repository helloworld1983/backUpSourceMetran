...
/* #0003	   2017/08/29	  Quyen Ngo				modify			*/
/*	- Remove some alarm Id not use on E_AlarmID enum				*/
/*	- Remove E_AnypalStatus											*/
/*	- Add compressor COMP_EXIT_REBOOT_SEQ							*/
/* #0004	   2017/09/08	  Viet Le				modify			*/
/*	- Edit eGotoBatteryAlarmMode->ePowerLostDetected				*/
/* #0005	   2017/09/12     Quyen Ngo				modify			*/
/*	- Remove eGotoBatteryStop mode 									*/
...
/* #0007	   2017/09/22     Linh Nguyen			modify			*/
/*	- Modify E_AlarmId for unit test, remove unuse ID				*/
/* #0008	   2017/09/28     Linh Nguyen			modify			*/
/*	- Modify E_AlarmId to same the M4 file							*/
/* #0009	   2017/10/07	  Quyen Ngo				modify			*/
...
/* #0010	   2017/11/02	  Quyen Ngo				modify			*/
/*	 - Add struct ADC_SENSOR_t for return AD value (bug 2012)		*/
/* #0011	   2017/11/02	  Quyen Ngo				modify			*/
...
#define IRQ_PRIO_IPC              3
#define ENCODER_INT_PRIO	3
#define POWER_DETECT_INT_PRIO     2
#define FC_USART3_INT_PRIO  	  3
#define COMP_USART0_INT_PRIO      3
/*
...
typedef enum
{
	COMP_NORMAL_SEQ,
	COMP_RESET_SEQ,
	COMP_WAIT_FOR_START_SEQ,
	COMP_REBOOT_SEQ,
	COMP_EXIT_REBOOT_SEQ,
	COMP_START_SEQ
