...
#define configTOTAL_HEAP_SIZE                   1024*1024//10240
#define configAPPLICATION_ALLOCATED_HEAP        1//1
//End Viet
...
#define configTIMER_TASK_PRIORITY		( 5 )//( 0 )
...
//2017/09/21 Quyen Ngo add define
