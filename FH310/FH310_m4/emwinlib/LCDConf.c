...
//
#define XSIZE_PHYS  800//(BOARD_LCD.PPL)
#define YSIZE_PHYS  480//(BOARD_LCD.LPP)
...
#define DISPLAY_ORIENTATION  0//(GUI_SWAP_XY | GUI_MIRROR_Y)
...
#define TOUCH_X_MAX  (XSIZE_PHYS)
#define TOUCH_Y_MIN  (         0)
#define TOUCH_Y_MAX  (YSIZE_PHYS)
 ...
 */
#ifndef   VRAM_ADDR
#define VRAM_ADDR  (FRAMEBUFFER_ADDR) // TBD by customer: This has to be the frame buffer start address
#endif
#ifndef   XSIZE_PHYS
...
bool display_Landscape = LANDSCAPE;
bool display_MirrorY = DISPLAY_ORIENTATION & GUI_MIRROR_Y;
