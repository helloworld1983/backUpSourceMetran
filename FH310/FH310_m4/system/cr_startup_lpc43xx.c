...
void (* const g_pfnVectors[])(void) = {
	...
	(void (*)(void))M4_Image_Magic,                              // Reserved
	(void (*)(void))&__M4Signature,                              // Reserved
    0,                              // Reserved
...
//
    ...
    //2017/09/19 Change from 0x00DF1000 to 0x00FF1000 for reset EMC
    *(RESET_CONTROL + 0) = 0x00FF1000; //Q_change from 0x10DF1000 to 0x00DF1000 for avoid reset GPIO
