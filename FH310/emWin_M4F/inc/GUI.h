...
#define GUI_KEY_OPER			  39		//user define for JPAP operation
...
#define GUI_ID_TEXT17		GUI_ID_USER + 8
#define GUI_ID_TEXT18		GUI_ID_USER + 9
#define GUI_ID_TEXT19		GUI_ID_USER + 10
