...
lcdb_result_t ea_lcdb_getLcdParams(LCD_CONFIG_T* lcdParams)
{
	...
	//	lcdParams->ACB = 1;
	//	lcdParams->Dual = 0;
	//	lcdParams->color_format = LCD_COLOR_FORMAT_RGB;
	//	lcdParams->Clock = 9000000;
	//	lcdParams->BPP = 6;
	//	lcdParams->LCD = LCD_TFT;
	...
	//Change the LCD parameter as Takeuchi san request for reduce flicker noise of LCD
	lcdParams->HBP = 46;
	lcdParams->HFP = 18;
	lcdParams->HSW = 2;
	lcdParams->PPL = 800;
	...
	lcdParams->Dual = 0;
	lcdParams->color_format = LCD_COLOR_FORMAT_RGB;
    lcdParams->Clock = 27216000;   //13608000;
	lcdParams->BPP = 6;
	lcdParams->LCD = LCD_TFT;
