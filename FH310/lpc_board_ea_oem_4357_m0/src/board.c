...
void Board_UART_Init(LPC_USART_T *pUART)
{
	if (pUART == LPC_USART0) {
		...
		Chip_SCU_PinMuxSet(0x9, 3, (SCU_MODE_PULLDOWN | SCU_MODE_FUNC7));			/* P9.3 : UART3_TXD */
		Chip_SCU_PinMuxSet(0x9, 4, (SCU_MODE_INACT | SCU_MODE_INBUFF_EN | SCU_MODE_ZIF_DIS | SCU_MODE_FUNC7));	/* P9.4 : UART3_RXD */
	}
}
