...
#define SCU_MODE_HIGHSPEEDSLEW_DIS (0x0 << 5)		/*!< Enable high-speed slew */
#define SCU_MODE_INBUFF_EN         (0x1 << 6)		/*!< Enable Input buffer */
#define SCU_MODE_INBUFF_DIS        (0x0 << 6)		/*!< Enable Input buffer */
#define SCU_MODE_ZIF_DIS           (0x1 << 7)		/*!< Disable input glitch filter */
#define SCU_MODE_ZIF_EN            (0x0 << 7)		/*!< Disable input glitch filter */
