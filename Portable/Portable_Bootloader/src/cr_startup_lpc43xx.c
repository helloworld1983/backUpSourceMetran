...
#define SIGNATURE_BOOT_MAGIC 		 	0xF00D4BAD
...
static const struct image_sig __BootloaderSignature = {
	SIGNATURE_BOOT_MAGIC,	/* M4 Image magic signature */
	__DATE__,
	__TIME__,
	PORTABLE_BOOTLOADER_VERSION
};
...
void (* const g_pfnVectors[])(void) = {
	...
	(void (*)(void))Bootloader_Image_Magic,                              // Reserved
	(void (*)(void))&__BootloaderSignature,                              // Reserved
    0,                              // Reserved
