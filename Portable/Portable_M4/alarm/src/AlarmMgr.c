...
static void alarmMgr_CheckFCAbnormalOxygenConcentration(uint16_t O2Concentration)
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckBreathErrorAlarmStatus( uint16_t flowRateSetting, bool isBreathTrigger, uint16_t flowPress)//E01
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckAbnormalOxygenConcentrationAlarmStatus(uint16_t flowRateSetting, uint16_t O2Concentration)//E02
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckLowOxygenConcentrationAlarmStatus(uint16_t flowRateSetting, uint16_t O2Concentration)//E03
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_OxygenTankPressureErrorAlarmStatus(float currentTankPressure)//E04
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckBatteryTemperatureErrorAlarmStatus(bool isBatteryInsert, uint16_t batteryStatus)//E05
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckBatteryChargeErrorAlarmStatus(bool isAC100VplugIn, bool isBatteryInsert,
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckBatteryRemainingCapacityLowerAlarmStatus(uint8_t currentBatteryCapacity,bool isBatteryInsert, bool isACPlugIn)//E07
{
	...
	if((devInterface_GetChargeSource()==eBatterySource)&&(isBatteryInsert==true)&&(stAlarmList[eAlarmBatteryType].currentStatus == eInactive))
	{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorSupplyPressureErrorAlarmStatus(uint16_t flowRateSetting,
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorSuctionPressureErrorAlarmStatus(float currentVacuumPressure)//E10
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControlErrorAlarmStatus(uint16_t flowRateSetting, uint16_t flowRateSensor)//E11
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckSupplyPressureSensorErrorAlarmStatus(float supplyPressure)//E12
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckVacuumPressureSensorErrorAlarmStatus(float vacuumPressure)//E13
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckTankPressureSensorErrorAlarmStatus(float tankPressure)//E14
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckDifferentialPressureSensorCommunicationErrorAlarmStatus(float differentialPressure)//E15
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckOxygenSensorErrorAlarmStatus(uint16_t O2Concentration)//E16
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerCommunicationNoResponseErrorAlarmStatus(uint8_t flowControllerStatus)//E17
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerPressureSensorErrorAlarmStatus(uint8_t flowControllerStatus)//E18
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerFlowSensorErrorAlarmStatus(uint8_t flowControllerStatus)//E19
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerTemperatureSensorErrorAlarmStatus(uint8_t flowControllerStatus)//E20
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerCommunicationErrorAlarmStatus(uint8_t flowControllerStatus)//E21
{
    static bool s_isSendFlowControllerResetCM = false;
    DEV_EVENT_STRUCT deviceQueue;
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerCommunicationChecksumErrorAlarmStatus(uint8_t flowControllerComunicationStatus)//E22
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerCommunicationCommandErrorAlarmStatus(uint8_t flowControllerComunicationStatus)//E23
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerCommunicationParameterErrorAlarmStatus(uint8_t flowControllerComunicationStatus)//E24
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerResponseCheckSumErrorAlarmStatus(E_FlowControllerNoAlarmStatus flowControllerResponseStatus)//E25
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerResponseCodeErrorAlarmStatus(E_FlowControllerNoAlarmStatus flowControllerResponseStatus)//E26
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckFlowControllerResponseDataLengthErrorAlarmStatus(E_FlowControllerNoAlarmStatus flowControllerResponseStatus)//E27
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorCommunicationNoResponseErrorAlarmStatus(uint16_t compressorStatus)//E28
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorDCOverVoltageErrorAlarmStatus(uint16_t compressorStatus)//E29
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorDCLowerVoltageErrorAlarmStatus(uint16_t compressorStatus)//E30
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorSoftwareOverCurrentErrorAlarmStatus(uint16_t compressorStatus)//E31
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorHardwareOverCurrentErrorAlarmStatus(uint16_t compressorStatus)//E32
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorBoardTemperatureErrorAlarmStatus(uint16_t compressorStatus)//E33
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorMotorTemperatureErrorAlarmStatus(uint16_t compressorStatus)//E34
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorRotationSpeedErrorAlarmStatus(uint16_t compressorStatus)//E35
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorStepOutErrorAlarmStatus(uint16_t compressorStatus)//E36
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorCommunicationErrorAlarmStatus(uint16_t compressorStatus)//E37
{
    static bool s_isSendCompressorResetCM = false;
    DEV_EVENT_STRUCT deviceQueue;
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorCommunicationChecksumErrorAlarmStatus(uint8_t compressorComunicationStatus)//E38
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorCommunicationCommandErrorAlarmStatus(uint8_t compressorComunicationStatus)//E39
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorCommunicationParameterErrorAlarmStatus(uint8_t compressorComunicationStatus)//E40
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorResponseCheckSumErrorAlarmStatus(E_CompressorStatus compressorResponseStatus)//E41
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorResponseCodeErrorAlarmStatus(E_CompressorStatus compressorResponseStatus)//E42
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckCompressorResponseDataLengthErrorAlarmStatus(E_CompressorStatus compressorResponseStatus)//E43
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckAudioCommunicateErrorAlarmStatus(bool audioCommunication)//E45
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckSpeakerErrorAlarmStatus(bool isSpeakerConnected)//E46
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckBatteryTypeAlarmStatus(bool isBatteryConnected, bool isInvalidBattery)//E48
{
...
/*                                                                                      */
/****************************************************************************************/
static void alarmMgr_CheckTachypneaErrorAlarmStatus(uint8_t breathRate, bool isBreathTrigger)//E49
{
