...
uint16_t logMgr_CheckTimePressLogValidReturnYear(POR_PRESS_LOG_T* log)
{
    ...
    {
        log->minute=MIN_MINUTE;
    }
    if(log->second>MAX_SECOND)
    {
        log->second=MIN_SECOND;
    }
    return log->year;
}
/****************************************************************************************/
...
/*                                                                                      */
/****************************************************************************************/
uint16_t logMgr_CheckTimeLogValidReturnDay(POR_LOG_T* log)
{
    if(log->year<MIN_YEAR)
    {
        log->year=MIN_YEAR;
...
/*                                                                                      */
/****************************************************************************************/
void logMgr_ConvertPressureLogToBinaryArray(POR_PRESS_LOG_T* log, uint8_t* logArray)
{
...
/*                                                                                      */
/****************************************************************************************/
void logMgr_ConvertLogToBinaryArray(POR_LOG_T log, uint8_t* logArray)
{
    memset(logArray,'\0',LOG_LENGTH);
    logArray[0] = 0xAB;
...
/*                                                                                      */
/****************************************************************************************/
uint32_t logMgr_GetNumberOfLog(uint32_t NumLogSave)
{
    uint32_t tempNumLogSave = 0;

    if(NumLogSave >= MAX_NUMBER_OF_SAVED_LOG)
    {
        tempNumLogSave = MAX_NUMBER_OF_SAVED_LOG;
    }
    else
    {
        tempNumLogSave = NumLogSave;
    }
