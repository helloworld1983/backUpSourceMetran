...
PRAGMA_ALIGN_32
EHCI_HOST_DATA_T ehci_data[MAX_USB_CORE];
//EHCI_HOST_DATA_T ehci_data;
PRAGMA_ALIGN_4096
NextLinkPointer PeriodFrameList0[FRAME_LIST_SIZE];
PRAGMA_ALIGN_4096
NextLinkPointer PeriodFrameList1[FRAME_LIST_SIZE];
